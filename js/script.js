...
createApp({
    ...
    methods: {
        ...
        filteredCandidates() {
            ...
            if (!this.showAll) {
                if (this.showDems) {
                    newCandidates = newCandidates.filter(item => item.party == 'D');
                } else if (this.showReps) {
                    newCandidates = newCandidates.filter(item => item.party == 'R');
                }
            }
